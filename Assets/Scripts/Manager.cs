...
public class Manager : MonoBehaviour
{
    ...
    public Canvas SelfReport;               // Self-report questionnaire
    ...
    {        
        ...
        if(!ExperimentDone && !isDark && hasAnswered && SteamVR_Actions.default_PosnerClicks.GetStateDown(SteamVR_Input_Sources.RightHand)) {
            CurrentTrial += 1;
            NewTrial = true;
            DarkTimer = TimeInDarkList[CurrentTrial];
            isDark = true;
