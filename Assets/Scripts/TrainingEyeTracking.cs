...
namespace ViveSR
{
    namespace anipal
    {
        namespace Eye
        {
            public class TrainingEyeTracking : MonoBehaviour
            {
                [Header("Eye tracking")]
                public liblsl.StreamOutlet outlet;             // Creating the LSL outlet
                ...
                void Update()
                {
                    ...
                    //Debug.Log("Eye position: ("+eyePos[0]+", "+eyePos[1]+", "+eyePos[2]+")");
                }
